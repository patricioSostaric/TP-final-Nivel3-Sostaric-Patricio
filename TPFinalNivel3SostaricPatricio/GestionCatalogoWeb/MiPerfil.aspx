<%@ Page Title="" Language="C#" MasterPageFile="~/MiMasterPage.Master" AutoEventWireup="true" CodeBehind="MiPerfil.aspx.cs" Inherits="GestionCatalogoWeb.MiPerfil" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-4">
            <asp:Button Text="Guardar" CssClass="btn btn-secondary" ID="btnGuardar" OnClick="btnGuardar_Click"
                runat="server" />
                <a href="/">Regresar</a>
        </div>
    </div>
